"""
Generate rtl test vectors for matvec_fp16 and matvec_fp16_w16

Uses bit-exact fp16 models from rtl_ops.py, not numpy fp16

Test 1: 4x4 matrix
Test 2: 8x4 matrix
Test 3: 64x4 matrix packed for matvec_fp16_w16, 128-bit packed weights
"""
import sys
import os
import random
...
def pack_weights_w16(weights_i8, out_dim, in_dim, K=4):
...
if __name__ == '__main__':
  ...
  print(f'\nTest 3: 64x4 matvec_fp16_w16 packed')
  s3 = gen_test_w16('64x4', 64, 4, seed=103)
