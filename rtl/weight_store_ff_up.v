// FF_up (128 -> 512) weight bank. Co-locates with transformer_layer's
// u_ff_up matvec.

module weight_store_ff_up (
  input  wire        clk_i,
  ...
  always @(posedge clk_i) begin
    case (layer_r1)
      2'd0:    scale_o <= SCALE_BLOCK0_FF_UP_WEIGHT;
      2'd1:    scale_o <= SCALE_BLOCK1_FF_UP_WEIGHT;
      2'd2:    scale_o <= SCALE_BLOCK2_FF_UP_WEIGHT;
      default: scale_o <= SCALE_BLOCK3_FF_UP_WEIGHT;
    endcase
  end
