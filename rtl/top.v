...
module top (
  ...
  uart_rx #(.CLK_FREQ(25_000_000), .BAUD(115_200)) u_rx (
    .clk_i  (clk),
    .rst_i  (rst),
    .rx_i   (uart_rx_i),
    .data_o (rx_data),
  ...
  uart_tx #(.CLK_FREQ(25_000_000), .BAUD(115_200)) u_tx (
    .clk_i  (clk),
    .rst_i  (rst),
    .data_i (tx_data),
    .start_i(tx_start),
  ...
  always @(posedge clk) begin
    if (rst) begin
      ...
      // Heartbeat ~0.33s toggle at 25 MHz
      if (heartbeat_cnt == 23'd8_333_333) begin
        heartbeat_cnt <= 0;
